<template>
    <div class="setting-section cloud-account-section">
        ...
        <div class="setting-options" v-else>
            ...
            <div class="setting-option cloud-manage-hint">
                <span class="option-title">{{ t('cloud-projects-moved-hint-title') }}</span>
                <span class="hint-text">{{ t('cloud-projects-moved-hint-body') }}</span>
            </div>
            <div class="setting-option actions">
